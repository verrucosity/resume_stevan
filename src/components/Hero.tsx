...
const ROLES = ["Full Stack Engineer", "Product Builder", "Systems Architect", "eCommerce Expert"];
    ...
    >
      ...
      >
        ...
        >
          ...
          owning products end-to-end — from architecture to deployment. Specializing in eCommerce
          platforms, backend automation, and systems that{" "}
        ...
        >
          {[
            ...
            { value: "$40k+", label: "Revenue generated" },
            { value: "40%", label: "Efficiency gains" },
          ].map((m) => (
            <div key={m.label} className="px-8 py-6 flex flex-col gap-1">
              <span className="text-3xl lg:text-4xl font-bold text-[var(--accent)] tracking-tight">
                {m.value}
              </span>
